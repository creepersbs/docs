---
title: "What is Creepers? Free subdomain provider by CreeperHUB"
description: "Creepers is a free subdomain service operated by CreeperHUB for developers and Minecraft players, registered entirely via GitHub Pull Requests."
---

Creepers is a free subdomain provider operated by [CreeperHUB](https://creeperhub.net). Instead of a control panel or paid account, registration works through GitHub: you fork the repository, add a JSON file describing your DNS records, open a Pull Request, and a team member reviews and merges it. Once merged, your subdomain goes live — no fees, no credit card, no waiting list.
...
Creepers is open to anyone who wants a free, real domain name on the internet.
