---
title: "DNS record types supported in creepers.sbs registrations"
description: "Reference for every DNS record type in your creepers.sbs registration file: A, AAAA, CNAME, MX, NS, TXT, and SRV — with JSON examples and usage guidance."
---
